...
namespace Thallo\Navigation\Schema;

use Glueful\Database\Connection;
use Glueful\Extensions\Schema\StructuralVerifierInterface;

/**
 * Structural verifier for glueful/thallo-navigation (schema policy spec B7): create migrations prove the
 ...
 */
final class NavigationSchemaVerifier implements StructuralVerifierInterface
{
    /** @var array<string, list<string>> create migration => every table it creates */
    private const CREATED_TABLES = [
        '001_CreateNavigationMenusTable.php' => ['navigation_menus'],
    ...
    {
        return 'glueful/thallo-navigation';
    }
